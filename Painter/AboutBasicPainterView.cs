...
namespace Painter
{
    class AboutBasicPainterView : Form
    {
        ...
        const string PRODUCT_NAME = "Basic Painter";
        ...
        const string FORM_TEXT = "About Basic Painter";
        const string OK_BUTTON_TEXT = "OK";
        const string SCHOOL_HYBERLINK = "http://www.ntut.edu.tw";
        const string DEPARTMENT_HYBERLINK = "http://csie.ntut.edu.tw/csie/index_i.htm";
        const string LAB_HYBERLINK = "http://csie.ntut.edu.tw/labsdtl/";

        public AboutBasicPainterView()               //宣告建構元
        {
            Text = FORM_TEXT;
            FormBorderStyle = System.Windows.Forms.FormBorderStyle.FixedToolWindow;
            _aboutPictureBox.Image = global::Painter.Properties.Resources.painter;
        ...
        private void InitailizeItemSize()   //初始化物件大小
        {
        ...
        private void InitializeItemLocation()  //初始化物件位置
        {
        ...
        {
            System.Diagnostics.Process.Start(LAB_HYBERLINK);
        }

        private void ClickDepartmentNameLink(object sender, EventArgs e) //點課系的連結事件
        {
            System.Diagnostics.Process.Start(DEPARTMENT_HYBERLINK);
        }
